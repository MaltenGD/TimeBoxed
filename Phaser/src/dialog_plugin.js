...
export default class DialogBox{
	...
	/**
	 * Checks if the text is currently being animated.
	 * @returns {boolean} True if the text is animating, false otherwise.
	 */
	isAnimating() {
		return this.timedEvent !== undefined;
	}

	/**
	 * Skips the text animation and displays the full text instantly.
	 */
	skipAnimation() {
		this.timedEvent.remove();
