...
export class BaseScene extends Phaser.Scene {
    ...
    setInteractiveCursor() {
        this.input.setDefaultCursor('url(../../../images/Website_Images/CursorNormalShort.png) 10 5, auto');

        this.input.on('gameobjectover', () => {
            this.input.setDefaultCursor('url(../../../images/Website_Images/CursorOpenShort.png) 10 5, auto');
        })
